...
Ext
		.define(
				'AM.controller.materialDoc.report.StockQuerys',
				{
					...
					saveSelection : function(store, operation, eOpts) {
						...
						Ext.each(grid.selModel.selected.keys, function(value,
								index) {
					...
					setSelection : function(store, records, successful,
							operation, eOpts) {
					...
					exportToExcel : function(button) {
						...
						var param;
						param = 'filter='
								+ encodeURIComponent(Ext.JSON.encode(tmp))
