 ...
 */
Ext.define('AM.portal.classes.PortalPanel', {
    ...
    initEvents : function(){
        this.callParent();
        this.dd = Ext.create('AM.portal.classes.PortalDropZone', this, this.dropConfig);
    },
    ...
    beforeDestroy : function() {
        ...
        AM.portal.classes.PortalPanel.superclass.beforeDestroy.call(this);
    }
});
